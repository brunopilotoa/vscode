...
vti_aprovado["dias_para_vti"] = vti_aprovado["dias_para_vti"].dt.days
# print(vti_aprovado["Data VTI"].dtype)
# print(vti_aprovado["Data Recebimento"].dtype)
print(vti_aprovado["dias_para_vti"])
...
with col3:
    st.metric(label="Meta", value=40, border=True)
# vti_aprovado["Data VTI"] = pd.to_datetime(vti_aprovado["Data VTI"])
# vti_aprovado["Data VTI"] = vti_aprovado["Data VTI"].dt.strftime("%m/%y")
tab1, tab2 = st.tabs(["Aprovadas Em VTI ", "Entregues"])
with tab1:
    (
        col1,
        col2,
